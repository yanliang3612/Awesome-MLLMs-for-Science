...
- [Related Survey Work](#1-related-survey-work)
  - [1.1 Survey for General LLMs](#11-survey-for-general-llms)
  - [1.2 Survey for General MLLMs](#12-survey-for-general-mllms)
  - [1.3 Surveys of LLMs & MLLMs for Medicine](#13-surveys-of-llms--mllms-for-medicine)
  - [1.4 Surveys of LLMs & MLLMs for Science](#14-surveys-of-llms--mllms-for-science)
- [MLLMs for Drug & Molecule](#2-mllms-for-drug--molecule)
  - [2.1 Molecular Representation Learning, Property and Interaction Prediction](#21-molecular-representation-learning-property-and-interaction-prediction)
  - [2.2 De Novo Molecular Generation with LLMs](#22-de-novo-molecular-generation-with-llms)
  - [2.3 Controlled Molecule Optimization and Editing](#23-controlled-molecule-optimization-and-editing)
  - [2.4 Chemical Reaction Prediction and Synthesis Planning](#24-chemical-reaction-prediction-and-synthesis-planning)
  - [2.5 Multi-Modal LLMs and Chemistry-Focused Agents](#25-multi-modal-llms-and-chemistry-focused-agents)
- [MLLMs for Protein](#3-mllms-for-protein)
  - [3.1 LLMs-Related Work](#31-llms-related-work)
  - [3.2 MLLMs-Related Work](#32-mllms-related-work)
    - [3.2.1 Protein Sequence-Language Integration](#321-protein-sequence-language-integration)
    - [3.2.2 Protein Structure-Sequence-Language Integration](#322-protein-structure-sequence-language-integration)
    - [3.2.3 Protein Interactions and Specialized Applications](#323-protein-interactions-and-specialized-applications)
- [MLLMs for Materials](#4-mllms-for-materials)
  - [4.1 LLMs-Related Work](#41-llms-related-work)
  - [4.2 MLLMs-Related Work](#42-mllms-related-work)
- [MLLMs for Genomics](#5-mllms-for-genomics)
  - [5.1 LLMs-Related Work](#51-llms-related-work)
  - [5.2 MLLMs-Related Work](#52-mllms-related-work)
